...
##################
#
# PATCHED BY GRUENEWALDT:
#   - 2017-09-02: Removed sanity check on SDKMAN_DIR!
#                 Not possible to install to other dir otherwise!
#
##################
#
...
# Global variables
#TODO Cut over from legacy url to propagated baseUrl once /res endpoint implemented
